...
?>
<body style=" margin-top: -2rem; margin-left: -1.5rem; margin-right: -2rem">
    @foreach ($commandes  as $index => $commande)
        ...
        <div class="col-5 @if($index % 2 == 1) colonne-2 @endif" style="border: 1px dashed  rgb(224, 147, 230);margin-bottom: 10px;width:800px">
            <div class="row">
            ...
            <div class="row" style="padding: 10px; margin-top: -4rem;font-size:15px">
                ...
                <i><u>Unité</u> : </i>@foreach ($commande->commande->details as $detail) {{$detail->produit->name}}, @endforeach<br>
