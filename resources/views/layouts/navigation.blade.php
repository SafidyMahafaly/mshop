...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static   menu-collapsed" data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow " data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item {{ Str::startsWith(request()->path(), 'colis') || Str::startsWith(request()->path(), 'colis') ? 'active' : ''}}"><a class="d-flex align-items-center" href="{{route('colis.index')}}"><i data-feather="circle"></i><span class="menu-title text-truncate" data-i18n="Email">Colis</span></a>
    ...
    <script src="{{asset('app-assets/js/scripts/pages/app-livreur-list.js')}}"></script>
    <script src="{{asset('app-assets/js/scripts/pages/app-livraison-list.js')}}"></script>
    <!-- END: Page JS-->
