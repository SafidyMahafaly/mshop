...
$(function () {
  ...
  var dtUserTable = $('.user-liveur-table')
  // Users List datatable
  if (dtUserTable.length) {
    dtUserTable.DataTable({
        ajax: {
            url: '/getLivreur', // Remplacez par l'URL de votre endpoint Laravel
            type: 'GET',
            dataSrc: ''
        },
        columns: [
...

            {
                ...
                render: function (data, type, full) {
                    ...
                    return (
                        ...
                        '<a href="' + commandeView + '" class="dropdown-item">' +
