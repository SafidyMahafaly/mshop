...
$(function () {
  ...
  var dtUserTable = $('.user-fournisseur-table')
  // Users List datatable
  if (dtUserTable.length) {
    dtUserTable.DataTable({
        ajax: {
            url: '/getFournisseur', // Remplacez par l'URL de votre endpoint Laravel
            type: 'GET',
            dataSrc: ''
        },
        columns: [
        ...
        columnDefs: [
...

            {
                ...
                render: function (data, type, full) {
                    var userView = '/editFournisseur/' + full.id; // Utilisez directement full.id
